...
{
    public function testIsTypeUnregistered()
    {
    ...
    */
    ...
    public function testNotStringOrObject()
    {
        DefinitionAssistant::ClearTypes();
        static::expectException(InvalidArgumentException::class);
        static::expectExceptionMessage(
    ...
    public function testNotDaftObject()
    {
        DefinitionAssistant::ClearTypes();
        static::expectException(InvalidArgumentException::class);
        static::expectExceptionMessage(
    ...
    public function testNotDaftObjectIsTypeUnregistered()
    {
        DefinitionAssistant::ClearTypes();
        static::expectException(InvalidArgumentException::class);
        static::expectExceptionMessage(
    ...
    public function testRegisterAbstractDaftObjectTypeIsNotAbstractDaftObject()
    {
        DefinitionAssistant::ClearTypes();
        static::expectException(InvalidArgumentException::class);
        static::expectExceptionMessage(
    ...
    public function testRegisterAbstractDaftObjectTypeHasAlreadyBeenRegistered()
    {
        DefinitionAssistant::ClearTypes();
